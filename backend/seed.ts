...
const familyData: { userId: number; members: { name: string; age: number }[] }[] = [
...
console.log('✅ Inserted family members');
...
console.log(`✅ Inserted ${announcementIds.length} announcements`);

// ── Comments ──────────────────────────────────────────────────────────────────

const commentData = [
  // On Jake's spelling test (index 0)
  ...
  // On James's support group (index 1)
  ...
  // On school enrollment tip (index 3)
  ...
  // On Marcus's 'Mom' moment (index 4)
...
commentData.forEach((c) => {
  ...
  created.setHours(created.getHours() - c.hoursBack);
...
const reactionData: { annIdx: number; userId: number; type: ReactionType }[] = [
  // Jake spelling test
  { annIdx: 0, userId: 1, type: 'celebrate' },
  { annIdx: 0, userId: 2, type: 'celebrate' },
  { annIdx: 0, userId: 3, type: 'love' },
  { annIdx: 0, userId: 4, type: 'like' },
  { annIdx: 0, userId: 5, type: 'celebrate' },
  { annIdx: 0, userId: 6, type: 'love' },
  // Support group reminder
  { annIdx: 1, userId: 0, type: 'like' },
  { annIdx: 1, userId: 2, type: 'like' },
  { annIdx: 1, userId: 5, type: 'like' },
  // Sofia recital
  { annIdx: 2, userId: 0, type: 'love' },
  { annIdx: 2, userId: 1, type: 'celebrate' },
  { annIdx: 2, userId: 3, type: 'love' },
  { annIdx: 2, userId: 5, type: 'celebrate' },
  { annIdx: 2, userId: 7, type: 'love' },
  // School enrollment tip
  { annIdx: 3, userId: 0, type: 'like' },
  { annIdx: 3, userId: 2, type: 'like' },
  { annIdx: 3, userId: 4, type: 'like' },
  { annIdx: 3, userId: 5, type: 'like' },
  // Marcus calling Linda 'Mom'
  { annIdx: 4, userId: 0, type: 'love' },
  { annIdx: 4, userId: 1, type: 'love' },
  { annIdx: 4, userId: 2, type: 'love' },
  { annIdx: 4, userId: 3, type: 'love' },
  { annIdx: 4, userId: 5, type: 'hug' },
  { annIdx: 4, userId: 6, type: 'love' },
  { annIdx: 4, userId: 7, type: 'love' },
  // Therapist request
  { annIdx: 5, userId: 0, type: 'support' },
  { annIdx: 5, userId: 2, type: 'support' },
  { annIdx: 5, userId: 7, type: 'like' },
  // Arjun robotics
  { annIdx: 6, userId: 0, type: 'celebrate' },
  { annIdx: 6, userId: 1, type: 'celebrate' },
  { annIdx: 6, userId: 2, type: 'celebrate' },
  { annIdx: 6, userId: 4, type: 'love' },
  { annIdx: 6, userId: 7, type: 'celebrate' },
  // Emergency contact tip
  { annIdx: 7, userId: 0, type: 'like' },
  { annIdx: 7, userId: 3, type: 'like' },
  { annIdx: 7, userId: 5, type: 'like' },
  // Sleep regression
  { annIdx: 8, userId: 1, type: 'hug' },
  { annIdx: 8, userId: 2, type: 'support' },
  { annIdx: 8, userId: 3, type: 'hug' },
  { annIdx: 8, userId: 4, type: 'support' },
  // Kofi bio mom visit
  { annIdx: 9, userId: 0, type: 'love' },
  { annIdx: 9, userId: 2, type: 'love' },
  { annIdx: 9, userId: 4, type: 'celebrate' },
  { annIdx: 9, userId: 6, type: 'support' },
  // Sibling group
  { annIdx: 12, userId: 0, type: 'love' },
  { annIdx: 12, userId: 1, type: 'celebrate' },
  { annIdx: 12, userId: 4, type: 'celebrate' },
  { annIdx: 12, userId: 6, type: 'love' },
  { annIdx: 12, userId: 7, type: 'celebrate' },
  // IEP meeting
  { annIdx: 14, userId: 0, type: 'support' },
  { annIdx: 14, userId: 2, type: 'support' },
  { annIdx: 14, userId: 3, type: 'like' },
  { annIdx: 14, userId: 6, type: 'support' },
];
...
messageThreads.forEach((thread) => {
  ...
  thread.messages.forEach((m, i) => {
    const created = new Date();
    created.setHours(created.getHours() - m.hoursBack);
    const ts = created.toISOString().replace('T', ' ').slice(0, 19);
