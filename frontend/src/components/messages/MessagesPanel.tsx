...
export const MessagesPanel: React.FC = () => {
  ...
  const activeConv = conversations.find(
    (c) => c.partner_id === activePartnerId,
  );
      ...
      setConversations((prev) => [
        {
          ...
          partner_thumbnail: partner.thumbnail,
          content: "",
    ...
    <div
      className={[
        ...
        isMobile
          ...
          : "rounded-lg border-[1.5px] border-border shadow-sm",
      ].join(" ")}
      style={{
        ...
        (activePartnerId ? (
          <div className="flex flex-col min-w-0">
            ...
            <div className="px-5 py-[14px] border-b-[1.5px] border-border flex items-center gap-3">
              ...
              <Avatar
                src={activeConv?.partner_thumbnail || null}
                ...
                return (
                  ...
                  >
                    ...
                    <div className="max-w-[78%]">
                      ...
                      <div
                        className={`text-[0.72rem] text-muted mt-1 ${isMine ? "text-right" : "text-left"}`}
                      >
            ...
            <form
              onSubmit={handleSend}
              className="px-5 py-[14px] border-t-[1.5px] border-border flex gap-[10px]"
            >
              <input
                value={newMsg}
          ...
          <div className="flex items-center justify-center flex-col gap-3 text-muted">
            ...
            <p className="font-semibold">
              Select a conversation or search for a member
            </p>
          </div>
        ))}
    </div>
